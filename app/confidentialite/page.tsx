  ...
  return (
    <div className="min-h-screen pt-32 pb-20 px-4">
      <div className="mx-auto max-w-3xl space-y-8">
        <h1 className="text-4xl font-display text-dp-ink">Politique de Confidentialité</h1>
        ...
        <section className="space-y-3">
          ...
          <ul className="text-sm text-dp-ink/50 space-y-1 list-disc list-inside">
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-dp-ink/50 leading-relaxed mt-3">
