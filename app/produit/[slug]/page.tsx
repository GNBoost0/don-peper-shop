  ...
  if (!product) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center px-4">
        ...
        <Link href="/boutique" className="text-dp-gold hover:text-dp-gold transition-colors">
    ...
    >
      <div className="mx-auto max-w-7xl px-4">
        ...
        <motion.nav
          ...
          className="mb-8 flex items-center gap-2 text-sm text-dp-ink-muted"
        >
          ...
          <span>/</span>
          <span className="text-dp-ink-muted">{flavor.name}</span>
        </motion.nav>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          >
            ...
            >
              <p className="text-xs text-dp-ink-muted uppercase tracking-wider">Infusion</p>
            ...
            >
              <p className="text-xs text-dp-ink-muted uppercase tracking-wider">Origine</p>
            ...
            >
              <p className="text-xs text-dp-ink-muted uppercase tracking-wider">Degré</p>
          ...
          >
            <div>
              ...
              <p className="text-dp-ink leading-relaxed text-lg">
                {flavor.description}
              </p>
            </div>
            ...
            {/* Format selector */}
            <div>
              <p className="text-sm font-semibold text-dp-ink mb-3 uppercase tracking-wider">
                Choisir un format
              </p>
              <FormatSelector
            ...
            <div className="flex flex-col gap-4">
              <div className="flex items-center gap-4">
                <p className="text-sm font-semibold text-dp-ink uppercase tracking-wider">
                  Quantité
                </p>
              ...
              <div className="flex items-center justify-between gap-4">
                <div>
                  <p className="text-xs text-dp-ink-muted uppercase tracking-wider">Prix total</p>
                  <p
            ...
            <div className="glass rounded-2xl p-6 space-y-3">
              <h3 className="text-sm font-semibold text-dp-ink uppercase tracking-wider mb-4">
                Caractéristiques
              </h3>
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  <p className="text-dp-ink-muted">Volume</p>
                  <p className="text-dp-ink">{currentFormat?.volume}</p>
                </div>
                <div>
                  <p className="text-dp-ink-muted">Degré d'alcool</p>
                  <p className="text-dp-ink">40%</p>
                </div>
                <div>
                  <p className="text-dp-ink-muted">Infusion</p>
                  <p className="text-dp-ink">3 mois minimum</p>
                </div>
                <div>
                  <p className="text-dp-ink-muted">Conservation</p>
                  <p className="text-dp-ink">À l'abri de la lumière</p>
                </div>
              </div>
            </div>

            {/* Shipping notice */}
            <div className="flex items-center gap-3 text-sm text-dp-ink-muted">
              <svg className="h-5 w-5 flex-shrink-0 text-dp-gold-dark" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
