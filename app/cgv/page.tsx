  ...
  return (
    <div className="min-h-screen pt-32 pb-20 px-4">
      <div className="mx-auto max-w-3xl space-y-8">
        <h1 className="text-4xl font-display text-white">Conditions Générales de Vente</h1>
        ...
        <section className="space-y-3">
          ...
          <p className="text-sm text-white/50 leading-relaxed">
            <strong className="text-white/70">Zones de livraison :</strong> France métropolitaine,
            Belgique, et les pays de l'Union Européenne.<br />
            <strong className="text-white/70">Frais de livraison :</strong> Offerts en France et en
            Belgique. 4,99€ pour le reste de l'Europe.<br />
            <strong className="text-white/70">Délais :</strong> Les commandes sont expédiées sous 48h
            ouvrées. Le délai de livraison est de 3 à 7 jours ouvrés selon la destination.<br />
            <strong className="text-white/70">Transport :</strong> Les colis sont expédiés via La Poste
